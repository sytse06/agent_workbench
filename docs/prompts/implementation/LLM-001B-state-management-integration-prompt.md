# Implementation Prompt: LLM-001B-state-management-integration

You are implementing **LLM-001B-state-management-integration** within strict architectural boundaries.
