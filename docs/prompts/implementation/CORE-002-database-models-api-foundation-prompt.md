# Implementation Prompt: CORE-002-database-models-api-foundation

You are implementing **CORE-002-database-models-api-foundation** within strict architectural boundaries.
