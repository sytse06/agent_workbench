# Implementation Prompt: LLM-001C-unified-dual-mode-workflow-system

You are implementing **LLM-001C-unified-dual-mode-workflow-system** within strict architectural boundaries.
