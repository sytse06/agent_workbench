...
help:
	...
	@echo "    APP_MODE=seo_coach make start-app-debug   - SEO Coach + debug"
	@echo "    APP_MODE=seo_coach make start-app-verbose - SEO Coach + verbose"
	@echo ""
	@echo "  Environment Options:"
	@echo "    ENV=staging make start-app      - Use staging environment"
	@echo "    ENV=production make start-app   - Use production environment"
	@echo ""
	@echo "📊 Git & Deployment:"
